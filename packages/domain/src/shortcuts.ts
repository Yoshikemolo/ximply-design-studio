...
export const COMMANDS: Command[] = [
  ...
  { id: "definePattern", label: "Define pattern", keys: [] },
  ...
  { id: "envelopeRelease", label: "Release envelope", keys: [] },
  { id: "envelopeOptions", label: "Envelope options", keys: [] },
  { id: "envelopeExpand", label: "Expand envelope", keys: [] },
  { id: "envelopeEdit", label: "Edit contents", keys: ["Mod+Shift+V"] },
  { id: "envelopeResetWarp", label: "Reset with warp", keys: [] },
  { id: "envelopeResetMesh", label: "Reset with mesh", keys: [] },
  { id: "shearDialog", label: "Shear", keys: [] },
