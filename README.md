...
**0.3.16-alpha.1 — single-user drawing workbench preview.** Work on several documents in tabs, draw floor plans with connected walls, openings, stairs and dimensions, draw editable cubic paths
