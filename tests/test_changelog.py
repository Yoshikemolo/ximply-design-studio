...
class ChangelogTests(unittest.TestCase):
    def test_bundled_notes_match_markdown_and_current_version(self):
        ...
        self.assertEqual('0.8.0', manifest['currentVersion'])
        ...
        for entry in manifest['entries']:
            if entry['version'] in ('0.8.0', '0.7.0', '0.6.0', '0.5.0', '0.4.0', '0.3.14-alpha.1', '0.3.13-alpha.1', '0.3.0-alpha.1', '0.3.5-alpha.1', '0.3.7-alpha.1', '0.3.9-alpha.1', '0.3.10-alpha.1'):
