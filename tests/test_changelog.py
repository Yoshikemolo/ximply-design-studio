...
class ChangelogTests(unittest.TestCase):
    def test_bundled_notes_match_markdown_and_current_version(self):
        ...
        self.assertEqual('0.3.3-alpha.1', manifest['currentVersion'])
        self.assertEqual(['0.3.3-alpha.1', '0.3.2-alpha.1', '0.3.1-alpha.1', '0.3.0-alpha.1', '0.2.0-alpha.2', '0.2.0-alpha.1', '0.1.0-design.2', '0.1.0-design.1'], [x['version'] for x in manifest['entries']])
