...
remains a local preview: the owner accepted it visually on 2026-09-22, but the strict
quality gate is still outstanding, so the version number records delivered scope, not
certified quality.
