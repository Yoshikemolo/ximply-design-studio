---
id: "REL-0026"
title: "Colour, gradients and patterns, and the studio on a phone"
status: "proposed"
domain: "changelog"
owners: ["Yoshikemolo"]
applies_to: ["ximply-design-studio"]
related: ["ADR-0033", "FEAT-0004", "FEAT-0008", "SC-0107", "SC-0108"]
source: ["Owner requests for 0.7.0: gradients, patterns, colour modes and swatches, the studio on phones, and lock and hide as Illustrator has them"]
version: "0.7.0"
date: "2026-09-22"
summary: "Gradients, patterns, swatches and colour modes, lock and hide as in Illustrator, and a studio that works on a phone"
breaking_changes: true
capability_status: "local-preview"
---

# 0.7.0 — Colour, gradients and patterns, and the studio on a phone

This release adds the colour options of chapter 16 of the Illustrator CS3 Help: fills
with gradients and patterns, a Gradient tool, Define Pattern, blends of gradients, colour
models and a Swatches panel. It also makes the studio usable on a phone, locks and hides
objects as Illustrator does and shows the document in Properties when nothing is
selected. It remains a local preview: the strict quality gate and visual acceptance of
this release are still outstanding, so the version number records delivered scope, not
certified quality.

## Breaking changes

- Documents that carry a gradient or pattern fill, patterns or swatches are refused by 0.6.0 and earlier editors and APIs, which do not know those fields (ADR-0033, proposed). Migration: to open such a document in an earlier version, set the fills back to plain colours and remove its patterns and swatches.
...
- Redraw the icons of the Bezier tools: the Pen as a fountain-pen nib, Add Anchor Point, Delete Anchor Point and Convert Anchor Point as the same nib with a plus, a minus or a small square at its top left corner. The Paintbrush and the raster brush now show a brush with a pointed tip, above a vector path or a painted stroke.
...
- Record the paint extension of the native format as a proposed decision, ADR-0033, awaiting owner review, with the scenarios of paints, SC-0107, and of the phone layout, SC-0108.
- Keep the paint model, its validation, the blending of gradients and the colour models in the domain package, tested against geometric and colour oracles; a PDF rendered by MuPDF painted the same pixels as the canvas.
